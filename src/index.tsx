  ...
  return c.render(
    <>
      ...
      <section class="text-center py-36 px-5">
        <div class="max-w-[1100px] mx-auto">
          ...
          <div class="flex gap-4 justify-center items-center flex-wrap">
            ...
            <a
              href="#"
              class="relative inline-block px-8 py-3.5 rounded-lg bg-slate-800 text-slate-500 font-semibold cursor-not-allowed"
            >
              Download for Windows
              <span class="absolute -right-2 -top-2 text-violet-500 text-[11px] font-bold uppercase tracking-wide">
                Coming Soon
              </span>
            </a>
          </div>
        ...
        <div class="max-w-[1100px] mx-auto px-5">
          ...
          <div class="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-8">
            {[
              ...
              { title: 'Session Control', desc: 'Organize repos, branches, and sessions in one workspace.' },
              { title: 'Developer First', desc: 'No wrappers. No abstractions. Full control.' },
            ].map((feature) => (
      ...
      <section class="py-24 bg-gradient-to-b from-[#0F172A] to-[#111c33]">
        <div class="max-w-[1100px] mx-auto px-5">
          ...
          <div class="flex justify-center gap-4 mb-12">
            <span class="px-6 py-2.5 rounded-lg bg-gradient-to-r from-teal-400 to-violet-500 text-white font-semibold text-sm">
              macOS
            </span>
            <span class="px-6 py-2.5 rounded-lg bg-slate-800 text-slate-500 font-semibold text-sm cursor-not-allowed relative">
              Windows
      ...
      <footer class="text-center p-10 text-slate-500 text-sm border-t border-[#1f2a44]">
        &copy; 2026 ParallelDev — Developed by Optiviselab |{' '}
        Follow on{' '}
